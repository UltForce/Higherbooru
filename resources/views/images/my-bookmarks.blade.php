...
<div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    ...
    <div class="search-function">
        <form method="GET" action="{{ route('images.myBookmarks') }}" class="flex items-center mb-4">
            <!-- Search Input -->
            ...
            <!-- Clear Search Button -->
            <a href="{{ route('images.myBookmarks') }}" class="clear-btn text-blue-500 hover:text-blue-700 ml-4 clear-btn">Clear Search</a>
        </form>
    </div>
        ...
        <div class="pagination-btn mt-6">
            {{ $bookmarkedImages->appends(request()->query())->links() }} <!-- Ensure query parameters are kept in pagination links -->
        </div>
    </div>
    </body>
    <!-- SweetAlert Script -->

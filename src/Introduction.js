  ...
  return (
    <>
      ...
      <div className="buy-plans">
        <h2>
          IT IS A PLACE WHERE YOU CAN SHOWCASE YOUR ARTISTIC TALENTS AND EXPOSE
          YOUR WORK
        </h2>
        <div className="subscription-options">
          ...
          <div className="subscription-option">
            ...
            <p>
              Our unique artwork appraisal system will evaluate your work on
              daily basis
            </p>
          </div>
          <div className="subscription-option">
          ...
          <div className="subscription-option">
            ...
            <p>
              Viewed from various angles, often conveying artistic expression
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="about-container">
          ...
          <div className="aboutus-p-container">
            <p>
              ...
              commemorate an important life event, Canva Corner is your portal
              to thousands of original works by today’s top artists.”
            </p>
          </div>
        </div>
      </div>
